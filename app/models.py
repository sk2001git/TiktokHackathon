...
class ComplianceResult(BaseModel):
    # This field is now guaranteed to be populated by the backend logic in main.py
    criterion_id: str
    
    # These fields come from the LLM output
...
class LegalDocument(BaseModel):
    ...
    # --- START: INGESTION FIX ---
    # Add the missing field used for duplicate detection
